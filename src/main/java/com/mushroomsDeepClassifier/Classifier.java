...
/**
 * Created by Oliver on 4/5/2017.
 */
public class Classifier {

    public static void main(String[] args) throws Exception {
        new Classifier().run(args);
    }

    protected static final Logger log = LoggerFactory.getLogger(Classifier.class);
    protected static int height = 400;
    protected static int width = 400;
    protected static int channels = 3;
    protected static int numExamples = 11;
